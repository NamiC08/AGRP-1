...
-- mysql credentials
cfg.db = {
  host = "mysql-mariadb-4-101.zap-hosting.com", -- database ip (default is local)
  database = "zap346165-1",   -- name of database
  user = "zap346165-1",    --  database username
  password = "TLi32vd0Ma7fBbJx"   -- password of your database
}
